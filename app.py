...
# ============================================================
# FLASK-LOGIN USER COMPATIBILITY
# ============================================================
# database.User already provides get_id() and is_active, but the
# model does not inherit UserMixin. Flask-Login therefore cannot
# find current_user.is_authenticated on a logged-in User instance.
# Keep the existing database schema unchanged and provide the
# missing Flask-Login properties here.
# ============================================================
